...
/**
 * View for Presenter Widget for Cer Version List
 * 
 * same as CurriculumVersionList but with different proxy
 * 
 * @author Lucas Reeh
 * 
 */
public class MyCurriculumVersionListView extends ViewImpl implements
		MyCurriculumVersionListPresenter.MyView {

	private final Widget widget;

	public interface Binder extends UiBinder<Widget, MyCurriculumVersionListView> {
	}
	 ...
	 */
	@Inject
	public MyCurriculumVersionListView(final Binder binder, Provider<CurriculumRequestFactory> provider) {
