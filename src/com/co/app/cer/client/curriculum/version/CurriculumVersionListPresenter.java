 ...
 * 
 */
public class CurriculumVersionListPresenter extends
		PresenterWidget<CurriculumVersionListPresenter.MyView> {
	 ...
	 */
	@Inject
	public CurriculumVersionListPresenter(final EventBus eventBus,
			final MyView view) {
		super(eventBus, view);
	}
